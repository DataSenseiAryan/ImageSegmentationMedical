...
def upload_file():
	if request.method == 'POST':
		...
		if file and allowed_file(file.filename):
			...
			imsave('/home/ryan/stark/myimage.jpg' ,catOrDog(image))
			...
			<img src = home/ryan/stark/myimage.jpg'>
	...
	return '''
	<!doctype html>
	<title>Upload new File mcccccccc</title>
	<h1>Upload new File terimaki</h1>
	<form method=post enctype=multipart/form-data>
	 image 
	 <input type=file name=file> <br>
	 <input type=submit value=Uploadkarlaude>
	</form>
	'''
